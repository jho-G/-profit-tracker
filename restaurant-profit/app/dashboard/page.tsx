...
export default async function DashboardPage({
  ...
  const tab = allParams.tab === "menu" ? "menu" : allParams.tab === "history" ? "history" : allParams.tab === "qr" ? "qr" : "sell";
      ...
      <div className="mx-auto w-full max-w-[480px] rounded-[2rem] border border-stone-200 bg-white shadow-sm">
        <div className="flex items-center justify-between border-b border-stone-100 px-5 py-4">
          ...
          <div className="flex items-center gap-2">
            <button type="button" className="rounded-full border border-stone-200 bg-white p-2 text-stone-700 transition hover:bg-stone-50 focus:outline-none focus:ring-2 focus:ring-stone-900/30">
              ...
              <div className="rounded-2xl border border-stone-200 bg-stone-50 p-4">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  ...
                  <form className="flex flex-wrap items-center gap-2" action="/dashboard" method="GET">
                    ...
                    <input id="start-date" type="date" name="start" aria-label="Start date" className="rounded-xl border border-stone-300 px-2 py-2 text-xs" />
                    <label className="sr-only" htmlFor="end-date">End date</label>
                    <input id="end-date" type="date" name="end" aria-label="End date" className="rounded-xl border border-stone-300 px-2 py-2 text-xs" />
                    <button className="rounded-xl bg-stone-900 px-3 py-2 text-[11px] font-black text-white transition hover:bg-stone-800 focus:outline-none focus:ring-2 focus:ring-stone-900/30">Apply</button>
                  </form>
                </div>
              </div>
